...
public class TextTranslator {
	...
	public void createData()
	{
			...
			String MalayTextStorage = "Malay.txt";
			String ArabicTextStorage = "Arabic.txt";
			String KoreanTextStorage = "Korean.txt";
			...
			try
			{
				...
				fileOutputStreamBm = new FileOutputStream(MalayTextStorage);
				...
				fileOutputStreamArb = new FileOutputStream(ArabicTextStorage);
				...
				fileOutputStreamKrn = new FileOutputStream(KoreanTextStorage);
