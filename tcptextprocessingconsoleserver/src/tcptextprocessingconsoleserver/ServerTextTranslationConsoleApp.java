	...
	public static void main (String [] args) throws IOException
	{
		...
		textTranslator.createData();
				...
				try
				{
					...
					int portNo = 6789;
					svSocket = new ServerSocket(portNo);
					...
					while (true) {
						...
						if(languageChoice == 1)
						{
							...
							language = "Malay";
							translated = textTranslator.translateToBM(text);
						}
						...
						else if(languageChoice == 2)
						{
							...
							language = "Arabic";
							translated = textTranslator.translateToArb(text);
						}
						...
						else if(languageChoice == 3)
						{
							...
							language = "Korean";
							translated = textTranslator.translateToKrn(text);
						}
